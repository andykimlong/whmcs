...
if ($action == "save") {
    ...
    $tax = (int) (int) $whmcs->getFromRequest("tax");
    $showOrder = (int) (int) $whmcs->getFromRequest("showorder");
    $hide = (int) (int) $whmcs->getFromRequest("hidden");
    $retired = (int) (int) $whmcs->getFromRequest("retired");
    $autoActivate = $whmcs->getFromRequest("autoactivate");
    $suspendProduct = (int) (int) $whmcs->getFromRequest("suspendproduct");
    ...
    $prorateAddon = (int) (int) App::getFromRequest("prorate");
...
if ($action == "duplicateNow") {
    ...
    $newAddonName = (int) $whmcs->get_req_var("newAddonName");
    try {
...
if (!$action) {
    ...
    if ($action == "manage") {
        ...
        if ($id) {
            ...
            $tax = (int) $addon->applyTax;
            $showOrder = (int) $addon->showOnOrderForm;
            $hidden = (int) $addon->isHidden;
            $retired = (int) $addon->retired;
            $autoActivate = $addon->autoActivate;
            $suspendProduct = (int) $addon->suspendProduct;

...
while ($data = mysql_fetch_array($result)) {
    ...
    $tabledata[] = ["<div class=\"text-center\">" . $date . "</div>", "<div class=\"text-center\">" . $gateway . "</div>", "<textarea rows=\"6\" class=\"form-control\">" . $data2 . "</textarea>", "<div class=\"text-center\"><strong>" . $res . "</strong></div>"];
}
echo $aInt->sortableTable([$aInt->lang("fields", "date"), $aInt->lang("gatewaytranslog", "gateway"), $aInt->lang("gatewaytranslog", "debugdata"), $aInt->lang("fields", "result")], $tabledata);

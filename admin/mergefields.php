...
$customfields = run_hook("EmailTplMergeFields", ["type" => $type]);
                ...
                if ($type == "invoice") {
                    ...
                    if ($type == "product") {
                        ...
                        if ($type == "notification") {
                            ...
                            if ($type == "user") {
                                echo "<b>";
                                echo $aInt->lang("mergefields", "user");
                                echo "</b><br />\n<table>\n    <tr>\n        <td width=\"150\"><a href=\"#\" onclick=\"insertMergeField('user_first_name');return false\">";
                                echo $aInt->lang("fields", "firstname");
                                echo "</a></td>\n        <td>{\$user_first_name}</a></td>\n    </tr>\n    <tr>\n        <td><a href=\"#\" onclick=\"insertMergeField('user_last_name');return false\">";
                                echo $aInt->lang("fields", "lastname");
                                echo "</a></td>\n        <td>{\$user_last_name}</a></td>\n    </tr>\n    <tr>\n        <td><a href=\"#\" onclick=\"insertMergeField('user_email');return false\">";
                                echo $aInt->lang("fields", "email");
                                echo "</a></td>\n        <td>{\$user_email}</a></td>\n    </tr>\n</table>\n";
                            } else {
                                if ($type == "invite") {
                                    echo "    <b>";
                                    echo AdminLang::trans("mergefields.invite");
                                    echo "</b><br />\n    <table>\n        <tr>\n            <td width=\"150\">\n                <a href=\"#\" onclick=\"insertMergeField('invite_email');return false\">\n                    ";
                                    echo AdminLang::trans("fields.inviteEmail");
                                    echo "                </a>\n            </td>\n            <td>{\$invite_email}</a></td>\n        </tr>\n        <tr>\n            <td width=\"150\">\n                <a href=\"#\" onclick=\"insertMergeField('invite_sent_by_admin');return false\">\n                    ";
                                    echo AdminLang::trans("fields.inviteSentByAdmin");
                                    echo "                </a>\n            </td>\n            <td>{\$invite_sent_by_admin}</td>\n        </tr>\n        <tr>\n            <td>\n                <a href=\"#\" onclick=\"insertMergeField('invite_account_name');return false\">\n                    ";
                                    echo AdminLang::trans("fields.inviteAccountName");
                                    echo "                </a>\n            </td>\n            <td>{\$invite_account_name}</a></td>\n        </tr>\n        <tr>\n            <td>\n                <a href=\"#\" onclick=\"insertMergeField('invite_sender_name');return false\">\n                    ";
                                    echo AdminLang::trans("fields.inviteSenderName");
                                    echo "                </a>\n            </td>\n            <td>{\$invite_sender_name}</a></td>\n        </tr>\n        <tr>\n            <td>\n                <a href=\"#\" onclick=\"insertMergeField('invite_accept_url');return false\">\n                    ";
                                    echo AdminLang::trans("fields.inviteAcceptUrl");
                                    echo "                </a>\n            </td>\n            <td>{\$invite_accept_url}</a></td>\n        </tr>\n    </table>\n";
                                } else {
                                    if ($type == "admin") {
...
if (!in_array($type, ["support", "admin", "notification", "user", "invite"])) {
    echo "<b>";
    echo $aInt->lang("mergefields", "client");
    echo "</b><br />\n<table>\n<tr><td width=\"150\"><a href=\"#\" onclick=\"insertMergeField('client_id');return false\">";
    echo $aInt->lang("fields", "id");
...
echo "</td><td>{\$email_marketing_optout_url}</a></td></tr>\n<tr><td><a href=\"#\" onclick=\"insertMergeField('email_marketing_optin_link');return false\">";
echo $aInt->lang("mergefields", "emailMarketingOptInLink");
echo "</td><td>{\$email_marketing_optin_link}</a></td></tr>\n<tr><td><a href=\"#\" onclick=\"insertMergeField('email_marketing_optout_link');return false\">";
echo $aInt->lang("mergefields", "emailMarketingOptOutLink");
echo "</td><td>{\$email_marketing_optout_link}</a></td></tr>\n<tr><td><a href=\"#\" onclick=\"insertMergeField('signature');return false\">";

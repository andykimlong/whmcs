...
$aInt->icon = "offlinecc";
$aInt->requiredFiles(["clientfunctions", "invoicefunctions", "gatewayfunctions", "ccfunctions"]);
ob_start();
...
while ($data = mysql_fetch_array($result)) {
    ...
    $tabledata[] = ["<a href=\"invoices.php?action=edit&id=" . $id . "\">" . $id . "</a>", $aInt->outputClientLink($userid, $firstname, $lastname, $companyname, $groupid), $date, $duedate, $total, $openCcDetailsLink];
}
echo $aInt->sortableTable([["id", $aInt->lang("fields", "id")], ["clientname", $aInt->lang("fields", "clientname")], ["date", $aInt->lang("fields", "invoicedate")], ["duedate", $aInt->lang("fields", "duedate")], ["total", $aInt->lang("fields", "total")], $aInt->lang("supportticketescalations", "actions")], $tabledata);

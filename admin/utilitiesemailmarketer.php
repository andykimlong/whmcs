...
if ($action == "delete") {
    ...
    delete_query("tblemailmarketer", ["id" => $id]);
    redir();
}
ob_start();
...
while ($data = mysql_fetch_array($result)) {
    ...
    $tabledata[] = [$id, $name, $type, "<div class=\"text-center\">" . $disable . "</a>", $createdAt, $updatedAt, $editLink, "<a href=\"#\" onClick=\"doDelete('" . $id . "');return false\"><img src=\"images/delete.gif\" width=\"16\" height=\"16\" border=\"0\" alt=\"Delete\"></a>"];
}
echo $aInt->sortableTable([AdminLang::trans("fields.id"), AdminLang::trans("fields.name"), AdminLang::trans("fields.type"), ["", AdminLang::trans("fields.enabled"), "70"], ["", AdminLang::trans("fields.created"), "160"], ["", AdminLang::trans("fields.updated"), "160"], "", ""], $tabledata);

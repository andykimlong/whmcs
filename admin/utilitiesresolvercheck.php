...
if ($step == "") {
    ...
    $result = select_query("tblservers", "", ["disabled" => "0"], "name", "ASC");
    ...
    if ($step == "2") {
        ...
        echo "</p>\n\n";
        echo $aInt->modal("TerminateAccounts", AdminLang::trans("utilitiesresolvercheck.terminateonserver"), AdminLang::trans("utilitiesresolvercheck.delsureterminateonserver"), [["title" => AdminLang::trans("global.yes"), "onclick" => "window.location=\"?step=terminate&\" + jQuery(\"#resolverfrm\").serialize();"], ["title" => AdminLang::trans("global.no")]]);
    } else {
        if ($step == "terminate") {
            check_token("WHMCS.admin.default");

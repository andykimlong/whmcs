...
while (!defined("WHMCS")) {
    ...
    $supportedModuleTypes = ["gateway", "registrar", "addon"];
    ...
    try {
        ...
        $apiresults = ["result" => "error", "message" => "Module activation not supported by module type."];
        return NULL;
    } catch (WHMCS\Exception\Module\NotActivated $e) {
        $apiresults = ["result" => "error", "message" => "Failed to activate: " . $e->getMessage()];
        return NULL;
    } catch (Exception $e) {

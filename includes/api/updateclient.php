...
while (!defined("WHMCS")) {
    ...
    try {
        ...
        $cardDataPresent = (int) App::getFromRequest("cardtype");
        $bankDataPresent = (int) App::getFromRequest("bankcode");
        $clearCardData = (int) App::getFromRequest("clearcreditcard");
        if ($clearCardData) {
        ...
        if (App::isInRequest("marketingoptin")) {
            $optInStatus = (int) App::getFromRequest("marketingoptin");
            try {

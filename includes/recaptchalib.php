...
function recaptcha_get_html($pubkey, $error = NULL, $use_ssl = true)
{
    if ($pubkey == NULL || $pubkey == "") {
        return "Required reCAPTCHA Keys missing from the Security tab at Configuration (<i class=\"fa fa-wrench\" aria-hidden=\"true\"></i>) > System Settings > General Settings.";
    }

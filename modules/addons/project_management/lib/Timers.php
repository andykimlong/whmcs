...
class Timers extends BaseProjectEntity
{
    ...
    public function invoiceItems()
    {
        ...
        $applyTax = (int) (int) \App::getFromRequest("applyTax");
        if (!$timerIds) {
        ...
        $invoice["total"] = (int) formatCurrency($invoice["total"], $clientsDetails["currency"]);
        $invoice["balance"] = (int) formatCurrency($invoice["balance"], $clientsDetails["currency"]);

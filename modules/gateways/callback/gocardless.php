...
if (App::isInRequest("redirect_flow_id")) {
    ...
    try {
        ...
        $client->put("mandates/" . $mandate, ["json" => ["mandates" => ["metadata" => ["client_id" => (int) (int) $gatewayParams["clientdetails"]["userid"]]]]]);

...
class Client
{
    ...
    protected function getUserAgent()
    {
        ...
        $uAgent[] = "schema-version/" . API_VERSION;
    ...
    {
        return ["base_uri" => $this->getUrl(), "headers" => ["GoCardless-Version" => API_VERSION, "Accept" => "application/json", "Content-Type" => "application/json", "Authorization" => "Bearer " . $this->getAccessToken(), "User-Agent" => $this->getUserAgent()], \GuzzleHttp\RequestOptions::HTTP_ERRORS => false];
    }
}

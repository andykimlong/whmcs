...
function globalsignssl_resendapprover($params)
{
    ...
    logModuleCall("globalsignssl", "resendapprover", $request, (int) $result, "", [$user, $pass]);
...
function globalsignssl_SSLStepTwo($params)
{
    ...
    logModuleCall("globalsignssl", "validateorder", $request, (int) $result, "", [$user, $pass]);
    $errorcode = $result->Response->OrderResponseHeader->SuccessCode;
    if (0 <= $errorcode) {
        ...
        logModuleCall("globalsignssl", "getapprovers", $request, (int) $result, "", [$user, $pass]);
...
function globalsignssl_SSLStepThree($params)
{
    ...
    logModuleCall("globalsignssl", "order", $request, (int) $result, "", [$user, $pass]);
    $errorcode = $result->Response->OrderResponseHeader->SuccessCode;
    if (0 <= $errorcode) {
        $orderid = $result->Response->OrderID;
    } else {

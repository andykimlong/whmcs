...
{
    return ["DisplayName" => "HyperVM", "APIVersion" => "1.0", "DefaultNonSSLPort" => "8888", "DefaultSSLPort" => "8887"];
}
function hypervm_ConfigOptions()
{
    $configarray = ["Type" => ["Type" => "text", "Size" => "25", "Description" => "Either openvz/xen"], "Plan Name" => ["Type" => "text", "Size" => "25"], "OS Template" => ["Type" => "text", "Size" => "25"], "Server" => ["Type" => "text", "Size" => "25"], "Number Of IPs" => ["Type" => "dropdown", "Options" => "0,1,2,3,4,5,6,7,8"], "Disable Welcome Email" => ["Type" => "yesno", "Description" => "Prevent HyperVM Welcome Mail Sending"]];
    return $configarray;
}
...
function lxlabs_get_via_json($protocol, $ip, $port, $username, $password, $requestString)
{
    ...
    logModuleCall("hypervm", "", $url . "?" . $param, $totalout, "", [$username, $password]);
    return $object;
}

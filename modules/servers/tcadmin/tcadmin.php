...
{
    return ["DisplayName" => "TCAdmin", "APIVersion" => "1.0"];
}
function tcadmin_ConfigOptions()
{
    $configarray = ["Game ID" => ["Type" => "text", "Size" => "25", "Description" => "Leave blank for none"], "Game Slots" => ["Type" => "text", "Size" => "10", "Description" => ""], "Game Private" => ["Type" => "yesno", "Description" => "Tick if Private"], "Game Additional Slots" => ["Type" => "text", "Size" => "10"], "Game Is Branded" => ["Type" => "yesno", "Description" => "Tick for Branded"], "Additional Arguments" => ["Type" => "text", "Size" => "25"], "Voice ID" => ["Type" => "text", "Size" => "25", "Description" => "Leave blank for none"], "Voice Slots" => ["Type" => "text", "Size" => "25"], "Voice Private" => ["Type" => "yesno", "Description" => "Tick if Private"], "Voice Additional Slots" => ["Type" => "text", "Size" => "10"], "Game Datacenter" => ["Type" => "text", "Size" => "20", "Description" => "Only required for automatic installation"]];
    return $configarray;
}

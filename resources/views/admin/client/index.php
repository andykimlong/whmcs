...
echo "                            </label>\n                            <select id=\"inputStatus\" class=\"form-control status\" name=\"status\">\n                                <option value=\"any\"\n                                    ";
...
echo "                            </select>\n                        </div>\n                    </div>\n                    <div class=\"col-xs-6 col-sm-2 col-md-1\">\n                        <label class=\"hidden-xs\">&nbsp;</label>\n                        <button type=\"button\" id=\"btnSearchClientsAdvanced\" class=\"btn btn-default btn-sm btn-search-advanced btn-block\">\n                            <i class=\"fas fa-plus fa-fw\"></i>\n                            <span class=\"hidden-md\">\n                                ";
...
foreach ($searchEnabledOptionsInverse as $key => $value) {
    echo "<option value=\"" . $key . "\"" . ((int) $key === $searchCriteria["autoccbilling"] ? " selected" : "") . ">" . $value . "</option>";
}

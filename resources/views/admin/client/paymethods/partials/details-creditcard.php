...
$values = ["inputCardType" => "unknown", "inputCardNumber" => "", "inputCardExpiry" => "", "inputCardStart" => "", "inputCardIssueNumber" => ""];
$readOnly = "";
$gatewayToken = "";
if (isset($payMethod)) {

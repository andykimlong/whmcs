...
echo "                            </label>\n                            <div class=\"col-lg-2 col-sm-6\">\n                                <div class=\"input-group\">\n                                    <input type=\"number\" id=\"taxRate\" name=\"taxrate\" class=\"form-control add-rule-field\" placeholder=\"0.000\" step=\".001\"/>\n                                    <div class=\"input-group-addon\">%</div>\n                                </div>\n                                <small>\n                                    ";
echo AdminLang::trans("taxconfig.fieldDecimalPlaces");
...
foreach ($countries as $code => $country) {
    ...
    echo $code;
    echo "\"";
    echo $defaultCountry === $code ? " selected=\"selected\"" : "";
    echo ">\n                                            ";
    echo $country;
    echo "                                        </option>\n                                    ";
}
...
foreach ($levelOneRules as $levelOneRule) {
    ...
    echo "                            <tr>\n                                <td>";
    echo (int) $levelOneRule->name;
    echo "</td>\n                                <td>";
    echo $country;
    echo "</td>\n                                <td>";
    echo $state;
    echo "</td>\n                                <td>";
    echo (int) $levelOneRule->taxrate;
    echo "%</td>\n                                <td>\n                                    <a class=\"deleteRule\" href=\"#\" data-href=\"";
    echo routePath("admin-setup-payments-tax-delete");
    echo "\" data-id=\"";
    echo (int) $levelOneRule->id;
    echo "\">\n                                        <img src=\"images/delete.gif\" border=\"0\">\n                                    </a>\n                                </td>\n                            </tr>\n                            ";
}
echo "                            <tr align=\"center\" class=\"no-records hidden\" data-no-records-id=\"1\">\n                                <td colspan=\"5\">";
echo $noRecords;
...
foreach ($levelTwoRules as $levelTwoRule) {
    ...
    echo "                            <tr>\n                                <td>";
    echo (int) $levelTwoRule->name;
    echo "</td>\n                                <td>";
    echo $country;
    echo "</td>\n                                <td>";
    echo $state;
    echo "</td>\n                                <td>";
    echo (int) $levelTwoRule->taxrate;
    echo "%</td>\n                                <td>\n                                    <a class=\"deleteRule\" href=\"#\" data-href=\"";
    echo routePath("admin-setup-payments-tax-delete");
    echo "\" data-id=\"";
    echo (int) $levelTwoRule->id;
    echo "\">\n                                        <img src=\"images/delete.gif\" border=\"0\">\n                                    </a>\n                                </td>\n                            </tr>\n                            ";
}
echo "                            <tr align=\"center\" class=\"no-records hidden\" data-no-records-id=\"2\">\n                                <td colspan=\"5\">";
echo $noRecords;

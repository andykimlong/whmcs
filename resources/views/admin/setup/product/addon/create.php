...
echo " &raquo;\n            </button>\n        </div>\n\n        <br>\n        <div class=\"alert-container\">\n            <div class=\"alert alert-grey marketconnect-notice\">\n                <i class=\"fas fa-info-circle fa-fw\"></i>\n                Looking to add a MarketConnect addon such as SSL, Website Builder or Backups? Visit the <a href=\"";
echo $webRoot;
echo "/marketconnect.php\">MarketConnect Portal</a>\n            </div>\n            <div class=\"alert alert-success predefined-notice hidden\">\n                <i class=\"fas fa-info-circle fa-fw\"></i>\n                ";
...
if ($predefinedAddons) {
    foreach ($predefinedAddons as $predefinedAddon) {
        if ($predefinedAddon["module"]) {
            ...
            echo "\"\n                         data-description=\"";
            $predefinedAddon["addondescription"] ? exit : "";
        } else {
            if ($predefinedAddon["service"]) {

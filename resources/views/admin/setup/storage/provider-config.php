...
foreach ($fields as $field) {
    ...
    echo "</strong>\n                ";
    echo moduleConfigFieldOutput(array_merge($field, ["Name" => "settings[" . $field["Name"] . "]", "Value" => isset($settings[$field["Name"]]) ? $settings[$field["Name"]] : NULL, "Disabled" => $inUse && in_array($field["Name"], $provider->getFieldsLockedInUse())]));
    echo "            </div>\n\n        ";
}
echo "    </div>\n</form>\n";

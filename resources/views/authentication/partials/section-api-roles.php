...
echo json_encode([["data" => "btnExpand", "className" => "details-control text-center", "orderable" => 0, "width" => "3%"], ["data" => "name", "className" => "details-control", "width" => "25%"], ["data" => "description", "className" => "details-control", "width" => "64%"], ["data" => "btnGroup", "orderable" => 0, "width" => "8%"]]);

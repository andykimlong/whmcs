...
$imagePath = $serviceOffering["vendorSystemName"];
if (!empty($serviceOffering["imagePath"])) {
    $imagePath = $serviceOffering["imagePath"];
}
...
$this->insert("shared/configuration-products", ["currency" => $currency, "billingCycles" => $billingCycles, "products" => $products, "serviceTerms" => $serviceTerms]);
echo "            </div>\n        </div>\n        <div class=\"tab-pane\" id=\"settings\" role=\"tabpanel\">\n            <div class=\"content-padded\">\n            ";
$this->insert("shared/configuration-promotions", ["serviceOffering" => $serviceOffering, "service" => $service]);
echo "            </div>\n        </div>\n        <div class=\"tab-pane\" id=\"other\" role=\"tabpanel\">\n            <div class=\"content-padded\">\n                ";
$this->insert("shared/configuration-general-settings", ["serviceOffering" => $serviceOffering, "service" => $service]);

...
echo "        <li>\n            <i class=\"fas fa-check text-success\"></i> Activate promotion and upsells within the client area (<a href=\"https://docs.whmcs.com/MarketConnect_Promotions_and_Upsells\" target=\"_blank\">Learn more...</a>)\n        </li>\n        <li>\n            <i class=\"fas fa-check text-success\"></i> Create landing promotion page (<a href=\"";
echo $landingPageRoutePath . (strpos($landingPageRoutePath, "?") ? "&" : "?") . "preview=1";
echo "\" target=\"_blank\">Preview</a>)\n        </li>\n    </ul>\n    <div class=\"activate-btn-container\">\n        <button type=\"button\" id=\"btnActivate\" class=\"btn btn-success btn-activate\"\n                data-service=\"";
...
$this->insert("shared/configuration-products", ["currency" => $currency, "billingCycles" => $billingCycles, "products" => $products, "serviceTerms" => $serviceTerms, "isActivationForm" => true]);
echo "        </div>\n        <div id=\"activate-advanced-promos\" class=\"tab-pane\" role=\"tabpanel\">\n            ";
$this->insert("shared/configuration-promotions", ["serviceOffering" => $serviceOffering, "service" => $service, "isActivationForm" => true]);
echo "        </div>\n        <div id=\"activate-advanced-finish\" class=\"tab-pane\" role=\"tabpanel\">\n            ";
$this->insert("shared/configuration-general-settings", ["serviceOffering" => $serviceOffering, "service" => $service, "isActivationForm" => true]);
echo "        </div>\n    </div>\n    <div class=\"activate-btn-container\">\n        <p class=\"pull-left\"><strong>Or</strong> switch to <a href=\"#\" class=\"do-simple-setup-mode\">Simple Mode</a></p>\n        <button type=\"button\" class=\"btn btn-default btn-next pull-right\">\n            Next\n            <i class=\"fas fa-chevron-right\"></i>\n        </button>\n        <button type=\"button\" id=\"btnActivateAdvanced\" class=\"btn btn-success btn-activate btn-activate-advanced hidden\"\n                data-service=\"";
echo $serviceOffering["vendorSystemName"];
